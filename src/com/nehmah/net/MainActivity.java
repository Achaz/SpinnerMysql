...
public class MainActivity extends Activity implements OnItemSelectedListener {
    ...
    private String URL_NEW_CATEGORY = "http://192.168.42.206/food_api/new_category.php";
    // Url to get all categories
    private String URL_CATEGORIES = "http://192.168.42.206/food_api/get_categories.php";
                ...
                try {
                    ...
                    if (jsonObj != null) {
                        ...
                        for (int i = 0; i < categories.length(); i++) {
                            ...
                            Category cat = new Category(catObj.getInt("id"),catObj.getString("name"));
